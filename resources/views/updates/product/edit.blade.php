            ...
            <div class="form login">
                ...
                <form action="{{url('catalogo/'.$catalogo->id_catalogo)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="input-field">
                        <input type="text" name="nombrep" id="nombrep" value="{{$catalogo->nombrep}}">
                        <img src="{{asset('Img/Assets/cookie.svg')}}" class="icon">
                    </div>
                    <div class="input-field">
                        <input type="number" name="precio" id="precio" value="{{$catalogo->precio}}">
                        <img src="{{asset('Img/Assets/price.svg')}}" class="icon">
                    </div>
                    <div class="input-field">
                        <input type="text" name="contenido_neto" id="contenido_neto" value="{{$catalogo->contenido_neto}}">
